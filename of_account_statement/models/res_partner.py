...
class Partner(models.Model):
    ...
    supplier_statement_ids = fields.One2many('supplier.statement', 'partner_id', string="Supplier Statements")
    customer_statement_ids = fields.One2many('supplier.statement', 'partner_id', string="Supplier Statements")
